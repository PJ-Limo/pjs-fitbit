...
const Header = ({ darkMode, toggleDarkMode, toggleSidebar }) => {
    return (
        <nav
            className="px-3 py-3 lg:px-5 lg:pl-3 w-full bg-slate-100 border-b border-gray-200 dark:bg-Navy dark:border-gray-700"
        >
            <div className="flex items-center justify-between">
                <div className="flex items-center justify-center rtl:justify-end">
                    <button
                        onClick={toggleSidebar}
                        className="inline-flex items-center p-1 text-sm text-white rounded-lg dark:text-Navy dark:hover:bg-Yellow dark:focus:ring-offset-white"
                    >
