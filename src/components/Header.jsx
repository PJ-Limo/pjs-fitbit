    ...
    <div className='px-3 py-3 lg:px-5 lg:pl-3'>
        <div className='flex items-center justify-between'>
            <div className='flex items-center justify-center rtl:justify-end'>
                <button className='inline-flex items-center p-2 text-sm text-white rounded-lg hover: bg-Yellow focus:outline-none focus:ring-2 focus:ring-offset-white dark:text-Navy dark:hover:bg-Yellow dark:focus:ring-offset-white'>
