...
const Home = () => {
  ...
  return (
    <div className="bg-cover flex flex-col justify-center items-center  h-screen bg-gray-100 dark:bg-Navy">
        <img src="/src/assets/Fitness-image-2.jpg" className='w-52 h-52 rounded-full object-cover object-top mb-10 shadow-xl' alt="home image" />
      ...
      <p className="text-sm italic  text-center font-thin mt-10 mb-10 text-Navy dark:text-Yellow">“Your journey starts today—stay consistent, stay committed.”</p>
    </div>
  );
};
